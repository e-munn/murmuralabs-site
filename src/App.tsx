      ...
      <footer className="border-t border-sand/20 py-16 px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex items-center gap-3 text-sm text-driftwood">
            <p>&copy; {new Date().getFullYear()} Murmura Labs. All rights reserved.</p>
            <span className="text-driftwood/40">|</span>
            <div className="flex items-center gap-1.5">
              <span>by</span>
              <a href="https://aretian.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center hover:opacity-80 transition-opacity">
              <svg viewBox="95 105 682 105" className="h-4" aria-label="Aretian Urban Analytics and Design" role="img">
