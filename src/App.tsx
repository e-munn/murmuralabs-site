...
export default function App() {
  return (
    <div className="min-h-screen bg-linen text-walnut">
      ...
      {/* Stats bar */}
      <section className="border-y border-sand/30 bg-[#f5f5f5]/40">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {CAPABILITIES.map((c) => (
              <div
                key={c.title}
                className="bg-[#f5f5f5]/40 border border-sand/30 rounded-xl p-6 hover:border-sand/60 transition-colors"
              >
      ...
      {/* How it works */}
      <section className="py-24 px-6 bg-[#f5f5f5]/40 border-y border-sand/30">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-2xl mb-16">
      ...
      {/* About / Team */}
      <section id="about" className="py-24 px-6 bg-[#f5f5f5]/40 border-y border-sand/30">
        <div className="max-w-4xl mx-auto text-center">
